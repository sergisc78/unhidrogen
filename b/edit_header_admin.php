...
error_reporting(E_ALL);
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div id="bloque">
					...
					<label>
                        ...
                        <input type="text" class="input" name="descrp_pie_fotol" value="<?php echo $resultats2['descrp_pie_foto'] ?>" >
                        <div class="line-box">
                            <div class="line"></div>
                        </div>
                    </label>
	...
	$sql = "UPDATE headers SET orden='$orden',tituloHeader='$tituloHeader',textoHeader='$textoHeader',linkLateral='$linkLateral',linkLateral='$descrp_pie_foto' WHERE id_headers='$id_headers'";
					...
					?>
			<meta http-equiv="refresh" content="2; URL=admin2" />
					<?php
                  }
