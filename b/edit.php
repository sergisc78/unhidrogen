	 ...
	 <a href="admin"><button class=" btn btn-outline-primary btn-lg consult-categorias" style="margin-top:20px;margin-left:600px">Volver a admin</button></a>
       ...
       <label>
                ...
                <label>
                    ...
                    <input type="date" class="input" name="fecha" value="<?php echo $resultats['fecha_post'] ?>" required>
                    <div class="line-box">
                        <div class="line"></div>
                    </div>
                </label>
               <label>
                    ...
                    <textarea id="intro" cols="90" rows="20" name="intro" value="<?php echo $resultats['introduccion_post'] ?>" required><?php echo $resultats['introduccion_post'] ?></textarea>
                </label>
				<h1>SEO</h1>
				 <label>
...
$id_post=$_GET['id_post'];
            ...
            try {
                ...
                if (isset($_GET['submit'])) {
					...
					?>
				<meta http-equiv="refresh" content="4;admin" />
					<?php
                }
            } catch (Exception $e) {
