...
$offset = ($pagina - 1) * $productosPorPagina;
		$sentencia = $connection->query("SELECT count(*) AS conteo FROM categorias WHERE url_categoria='$categoria'");
$conteo = $sentencia->fetchObject()->conteo;
	 $sql_consult8 = "SELECT * FROM categorias WHERE url_categoria='$categoria' LIMIT $limit OFFSET $offset";
...
//$mail->AltBody = 'This is a plain-text message body';
	...
	<div class="navPaginacion" style="width: 70%;
	margin-left: 15%;
	margin-right: 15%;">
	...
	<nav>
            <div class="row">
                <div class="">
                    <p style="display: inline-block;">Mostrando <?php echo $conteo    ?> de <?php echo $productosPorPagina ?></p>
                    <p style="display: inline-block; float: right;">Página <?php echo $pagina ?> de <?php echo $paginas ?> </p>
                </div>
            </div>
            <ul class="pagination">
                <!-- Si la página actual es mayor a uno, mostramos el botón para ir una página atrás -->
				 <li class="pagination">
                        <a class="pagination" href=".?pagina=<?php echo 1 ?>">
                ...
                <?php if ($pagina > 1) { ?>
                    ...
                    <li class="pagination">
                        <a class="pagination" href="./?pagina=<?php echo $pagina - 1 ?>">
                            <span aria-hidden="true"><?php echo "<"; ?></span>
                        </a>
                    </li>
			...
			?>
                    ...
                    <li class="pagination" syle="background-color:blue;">
                        <a class="pagination" href=".?pagina=<?php echo $x ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php 
			}
             ...
             if ($x==1){ ?>
                    <li class="pagination" style="background-color:blue;">
                        <a class="pagination" style="color: black; font-weight:bold;" href=".?pagina=<?php echo $x ?>">
                            <?php echo $x ?></a>
                    </li>
                <?php 
			} 
             ...
             if ($x!=1){ ?>
                ...
                <?php 
				 ...
				 <li class="pagination">
                        <a class="pagination" href=".?pagina=<?php echo $x-1 ?>">
                            <span aria-hidden="true"><?php echo ">>"; ?></span>
                        </a>
                    </li>
