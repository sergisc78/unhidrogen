...
<body>
    ...
    if (isset($_SESSION['email'])) {
        ...
        try {
            ...
            $sql_consult = "SELECT * FROM headers";
        ...
        ?>
                <div class="container">
 <h1 class="text-center">Todos los headers de los post </h1><br>
						<br>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <?php echo $resultats2['orden'] ?></td>
											 <td><a href="edit_header_admin.php?id_headers=<?php echo urlencode($resultats2['id_headers']); ?>"> <button title="Editar post" class=" btn btn-success editar "><i class="bi bi-pencil"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
