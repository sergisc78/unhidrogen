...
<head>
    ...
    <title>Editar post categoría</title>
...
<select name="descr_categoria" id="descr_categoria">
    ...
    <?php } ?>
        ...
        &nbsp;
        <button class="btn btn-danger" type="submit" name="guardar">Guardar categoría</button>
        <div id="enviar"></div>
    ...
    if (isset($_GET['guardar'])) {
        ...
        header("location:getCategoria?id_post=$id_post");
    }
    echo "<br>";
