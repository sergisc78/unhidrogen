                ...
                <div class="container">
                    ...
                    <table id="example" class="table table-striped display nowrap" spacecelling="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <h1 class="text-center">Todas las categorías</h1><br>
						 ...
						 <div class="d-flex justify-content-right">
                            <a href="admin4"><button class=" btn btn-outline-secondary btn-lg consult-categorias">Consultar todas las categorías del post</button></a>&nbsp;&nbsp;
                        </div>
							<div class="d-flex justify-content-right">
                            <a href="admin"><button class=" btn btn-outline-secondary btn-lg consult-categorias">Volver a admin</button></a>
									     ...
									     <div class="col-lg-12">
 <a href="crearcategoria.php"><button class="btn btn-primary" id='add' data-toggle="modal">Crear categoria&nbsp;&nbsp;<i class="bi bi-plus-circle-fill"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
												<a href="getCategoriaPost?id_categoria=<?php echo urlencode($resultats2['id_categoria']); ?>"><button type="button" class="btn btn-info">Todos los post de esta categoria</button></a>
												
												<a href="edit3.php?id_categorias=<?php echo urlencode($resultats2['id_categoria']);?>"> <button title="Editar post" class=" btn btn-success editar "><i class="bi bi-pencil"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                                                <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                                                            </svg></i></button></a>&nbsp;&nbsp;<button class="btn btn-danger deleteCategoria" data-id="<?php echo  $resultats2['id_categoria'] ?>" title="Borrar categoría"><i class="bi bi-trash"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        <script>
            $(document).ready(function() {
                ...
                */
                ...
                $(document).on('click', '.deleteCategoria', function(e) {
                    e.preventDefault();
